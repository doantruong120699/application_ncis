...
class ISSUE_DATE_FINDER:
    ...
    async def RUNNER(self, cnic, issuedate):
        ...
        async with aiohttp.ClientSession(headers=headers) as session:
            ...
            for single in issuedate:
                ...
                tasks.append(
                    asyncio.ensure_future(self.get_pokemon(session, url, payload))
                )
    ...
    def EXECUTOR(self, cnic):
        ...
        ISSUES_DATES_ALL = [
            ISSUE_DATE_GENERATOR(2013),
            ISSUE_DATE_GENERATOR(2014),
            ISSUE_DATE_GENERATOR(2015),
            ISSUE_DATE_GENERATOR(2016),
            ISSUE_DATE_GENERATOR(2017),
            ISSUE_DATE_GENERATOR(2018),
            ISSUE_DATE_GENERATOR(2019),
            ISSUE_DATE_GENERATOR(2020),
            ISSUE_DATE_GENERATOR(2021),
            ISSUE_DATE_GENERATOR(2022),
        ][::-1]
